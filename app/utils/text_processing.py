...
def chunk_document_content(content: str, max_chunk_size: Optional[int] = None) -> List[str]:
    """
    ...
    chunks = []
    overlap_size = int(max_chunk_size * settings.chunk_overlap_ratio)  # 25% overlap by default
